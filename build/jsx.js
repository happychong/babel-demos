(function (global, factory) {
    ...
    var DemoCompinent = function (_Component) {
        (0, _inherits3.default)(DemoCompinent, _Component);

        function DemoCompinent() {
            (0, _classCallCheck3.default)(this, DemoCompinent);
            return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(DemoCompinent).apply(this, arguments));
        }

        (0, _createClass3.default)(DemoCompinent, [{
            key: 'render',
